window.SimpleSlide = class {
    constructor(t) {
        (this.config = { slide: t.slide, auto: !1 !== t.auto, nav: !!t.nav && t.nav, time: t.time ? t.time : 5e3, pauseOnHover: !!t.pauseOnHover && t.pauseOnHover }),
            (this.pause = !1),
    ...
    activateSlide(t) {
        this.items.forEach((t) => t.classList.remove(this.activeClass)),
            t ? (t.classList.add(this.activeClass), this.activateNav(t)) : (this.items[0].classList.add(this.activeClass), this.activateNav(this.items[0]));
    }
    activateNav(t) {
        if (this.config.nav) {
