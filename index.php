    ...
    <header class="header">
        <div class="container">
            ...
            <nav class="header_menu grid-12">
                <ul>
                    <li><a href="/sobre" <?php if ($tituloAtual == '/sobre')
                        echo "class='menu_ativo'"; ?>> Sobre</a></li>
                    <li><a href="/produtos" <?php if ($tituloAtual == '/produtos')
                        echo "class='menu_ativo'"; ?>>Produtos</a></li>
                    <li><a href="/portfolio" <?php if ($tituloAtual == '/portfolio')
                        echo "class='menu_ativo'"; ?>>Portfólio</a></li>
                    <li><a href="/contato" <?php if ($tituloAtual == '/contato')
                        echo "class='menu_ativo'"; ?>>Contato</a>
                    </li>
                </ul>
            </nav>
        </div>
            ...
            <div class="container">
                <div class="grid-8 footer_historia">
                    ...
                    <p>
                        ...
                        apaixonados por pedalar e também por fazer as coisas com as nossas próprias mãos.
                    ...
                    <ul>
                        <li>
                            <a href="http://facebook.com" target="_blank"><img
                                    src="./public/img/redes-sociais/facebook.svg" alt="Facebook Bikcraft" /></a>
                        </li>
                        <li>
                            <a href="http://instragram.com" target="_blank"><img
                                    src="./public/img/redes-sociais/instagram.svg" alt="Instagram Bikcraft" /></a>
                        </li>
                        <li>
                            <a href="http://twitter.com" target="_blank"><img
                                    src="./public/img/redes-sociais/twitter.svg" alt="Twitter Bikcraft" /></a>
                        </li>
                    </ul>
                </div>
            </div>
